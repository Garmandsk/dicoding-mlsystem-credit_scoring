...
# 1. Load crential service account
...
def upload_directory(local_dir_path, parent_drive_id):
    ...
    for item_name in os.listdir(local_dir_path):
        ...
        if os.path.isdir(item_path):
            ...
            print(f"Uploading files: {item_name}")
            file_meta = {
                "name": item_name,
                "parents": [parent_drive_id]
            }
...
#   Kemudian buat folder sesuai run_id di shared drive (Tanpa folder mlruns agar tidak redundant)
